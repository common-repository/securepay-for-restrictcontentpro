function securepayrcp_bank_select( $, path_icon, path_time, version ) {
    $( document )
        .ready(
            function() {
                ...
                function formatBank( bank ) {
                    ...
                    return $( '<div class="securepayrcp-bnklogo"><div><img onerror="this.src=\'' + img_error + '\'" src="' + img + '?v=' + version + '"></div><div>' + bank.text + '</div></div>' );
                };
